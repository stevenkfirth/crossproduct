...
from crossproduct import Point, Points, Vector, Halfline, Line, Segment, Segments
...
class Test_Segment(unittest.TestCase):
    ...
    def test_distance_to_point(self):
        ...
        P0,P1=Point(0,0), Point(1,1)
        s=Segment(P0,P1)
        self.assertEqual(s.distance_to_point(Point(-2,0)),
                         2) 
        self.assertEqual(s.distance_to_point(Point(2,1)),
                         1) 
        self.assertEqual(s.distance_to_point(Point(0,1)),
                         0.5**0.5) 
        self.assertEqual(s.distance_to_point(Point(1,0)),
                         0.5**0.5) 
        
        P0, P1=Point(0,0,0), Point(1,1,1)
        s=Segment(P0,P1)
        self.assertEqual(s.distance_to_point(Point(-2,0,0)),
                         2) 
        self.assertEqual(s.distance_to_point(Point(1,1,2)),
                         1) 
        self.assertEqual(s.distance_to_point(Point(0,0,0)),
                         0) 
    ...
    def test_distance_to_segment(self):
        ...
        self.assertEqual(s.distance_to_segment(s),
                         0)
        self.assertEqual(s.distance_to_segment(Segment(P0+Vector(1,-1,0),
                                                         P1+Vector(1,-1,0))),
                         Vector(1,-1,0).length)
        self.assertEqual(s.distance_to_segment(Segment(P0,
                                                         Point(1,-1,0))), 
                         0)
        self.assertEqual(s.distance_to_segment(Segment(Point(-2,-2,-2),
                                                         Point(-1,-1,-1))),
                         Vector(1,1,1).length)
