...
.. autoclass:: crossproduct.polygon.Polygon3D
   :show-inheritance:
...
.. autosummary::
   ...
   ~crossproduct.polygon.Polygon3D.plane
   ~crossproduct.polygon.Polygon3D.plot
   ~crossproduct.polygon.Polygon3D.points
   ~crossproduct.polygon.Polygon3D.polyline
   ~crossproduct.polygon.Polygon3D.previous_index
